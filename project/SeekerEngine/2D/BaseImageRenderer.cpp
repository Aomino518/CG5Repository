...
BaseImageRenderer* BaseImageRenderer::GetInstance()
{
	static BaseImageRenderer instance;
	return &instance;
}

void BaseImageRenderer::Init(DxcCompiler& dxcCompiler, ID3D12RootSignature* rootSignature)
{
...
void BaseImageRenderer::Shutdown()
{
    psoMap_.clear();
    rootSignature_.Reset();
}

void BaseImageRenderer::PreDraw(EffectType type)
{
