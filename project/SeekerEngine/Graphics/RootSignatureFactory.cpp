...
Microsoft::WRL::ComPtr<ID3D12RootSignature> RootSignatureFactory::CreateParticle3D()
{
	// RootSignature作成
	D3D12_ROOT_SIGNATURE_DESC descriptionRootSignature{};
	descriptionRootSignature.Flags =
...
Microsoft::WRL::ComPtr<ID3D12RootSignature> RootSignatureFactory::CreateParticle2D()
{
	// RootSignature作成
	D3D12_ROOT_SIGNATURE_DESC descriptionRootSignature{};
	descriptionRootSignature.Flags =
...
Microsoft::WRL::ComPtr<ID3D12RootSignature> RootSignatureFactory::CreateDebugShape2D()
{
	// RootSignature作成
	D3D12_ROOT_SIGNATURE_DESC descriptionRootSignature{};
	descriptionRootSignature.Flags =
	...
	rootParameters[0].Descriptor.ShaderRegister = 0; // レジスタ番号0と使う
...
Microsoft::WRL::ComPtr<ID3D12RootSignature> RootSignatureFactory::CreateDebugShape3D() {
	// RootSignature作成
	D3D12_ROOT_SIGNATURE_DESC descriptionRootSignature{};
	descriptionRootSignature.Flags =
		D3D12_ROOT_SIGNATURE_FLAG_ALLOW_INPUT_ASSEMBLER_INPUT_LAYOUT;
...
Microsoft::WRL::ComPtr<ID3D12RootSignature> RootSignatureFactory::CreateOffScreen()
{
	// RootSignature作成
	D3D12_ROOT_SIGNATURE_DESC descriptionRootSignature{};
	descriptionRootSignature.Flags =
	...
	rootParameters[0].DescriptorTable.pDescriptorRanges = descriptorRange; // Tableの中身を指定
